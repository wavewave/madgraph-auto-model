...
V_10001 = Vertex(name = 'V_10001',
               particles = [ P.u, P.e__minus__, P.sd4__tilde__, P.sxxp ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFSS2 ],
               couplings = {(0,0):C.GC_10001})

V_10002  = Vertex(name = 'V_10002',
               particles = [ P.e__plus__, P.u__tilde__, P.sd4, P.sxxp__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFSS1],
               couplings = {(0,0):C.GC_10001})
...
V_10006 = Vertex(name = 'V_10006',
               particles = [ P.d, P.e__plus__, P.su1__tilde__, P.sxxp__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFSS1 ],
               couplings = {(0,0):C.GC_10001})
...
V_10010 = Vertex(name = 'V_10010',
               particles = [ P.d, P.u__tilde__, P.sl1__plus__, P.sxxp__tilde__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFSS1 ],
               couplings = {(0,0):C.GC_10001})
