...
V_10001 = Vertex(name = 'V_10001',
               particles = [ P.t, P.e__minus__, P.sd4__tilde__, P.sxxp ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFSS2 ],
               couplings = {(0,0):C.GC_10001})

V_10002  = Vertex(name = 'V_10002',
               particles = [ P.e__plus__, P.t__tilde__, P.sd4, P.sxxp__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFSS1],
               couplings = {(0,0):C.GC_10001})
...
V_10005 = Vertex(name = 'V_10005',
               particles = [ P.e__minus__, P.d__tilde__, P.su3, P.sxxp ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFSS2 ],
               couplings = {(0,0):C.GC_10001})

V_10006 = Vertex(name = 'V_10006',
               particles = [ P.d, P.e__plus__, P.su3__tilde__, P.sxxp__tilde__ ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFSS1 ],
               couplings = {(0,0):C.GC_10001})
...
V_10009 = Vertex(name = 'V_10009',
               particles = [ P.t, P.d__tilde__, P.sl1__minus__, P.sxxp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFSS2 ],
               couplings = {(0,0):C.GC_10001})

V_10010 = Vertex(name = 'V_10010',
               particles = [ P.d, P.t__tilde__, P.sl1__plus__, P.sxxp__tilde__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFSS1 ],
               couplings = {(0,0):C.GC_10001})
